...
![pumpkin img](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
!*/
/// Big orange thing
/// 
///  # Recipes
...
impl Pumpkin {
    /// If you smash the pumpkin it is gone and can't be used for pie
    pub fn smash(self) {}
}
